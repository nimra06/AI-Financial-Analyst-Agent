...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-accent text-white shadow-glow hover:bg-blue-500 active:scale-[0.98]",
        secondary:
          "bg-card text-text-primary border border-white/10 hover:bg-surface hover:border-white/15",
        ghost: "text-text-secondary hover:bg-white/5 hover:text-text-primary",
        outline:
          "border border-white/10 bg-transparent text-text-primary hover:bg-white/5",
      },
      size: {
