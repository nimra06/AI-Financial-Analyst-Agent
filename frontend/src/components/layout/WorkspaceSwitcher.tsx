...
export function UserMenu() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-full z-50 mt-2 w-56 rounded-xl border border-white/10 bg-surface py-1 shadow-xl">
          ...
          <button
            ...
            className="flex w-full items-center gap-2 px-3 py-2.5 text-sm text-text-secondary hover:bg-white/5 hover:text-text-primary"
          >
